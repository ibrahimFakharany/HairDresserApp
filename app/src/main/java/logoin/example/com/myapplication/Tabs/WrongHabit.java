...
public class WrongHabit extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.wrong_habit, container, false);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            CustomAdapter customAdapter = new CustomAdapter(data_poster, getContext(), "عادات خاطئة ابتعدى عنها");
